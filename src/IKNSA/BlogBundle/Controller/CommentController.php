...
class CommentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('IKNSABlogBundle:comment:index.html.twig', array(
            'comments' => $comments,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('IKNSABlogBundle:comment:new.html.twig', array(
            'comment' => $comment,
    ...
    public function showAction(Comment $comment)
    {
        ...
        return $this->render('IKNSABlogBundle:comment:show.html.twig', array(
            'comment' => $comment,
    ...
    public function editAction(Request $request, Comment $comment)
    {
        ...
        return $this->render('IKNSABlogBundle:comment:edit.html.twig', array(
            'comment' => $comment,
